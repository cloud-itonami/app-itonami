...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22123 = c;
var G__22123__$1 = (((G__22123 == null))?null:G__22123.prototype);
if((G__22123__$1 == null)){
return null;
} else {
return G__22123__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22129 = c;
var G__22129__$1 = (((G__22129 == null))?null:G__22129.prototype);
if((G__22129__$1 == null)){
return null;
} else {
return G__22129__$1.render;
}
})() == null)))));
});
...
while (G__22332__i < G__22332__a.length) {G__22332__a[G__22332__i] = arguments[G__22332__i + 0]; ++G__22332__i;}
  args = new cljs.core.IndexedSeq(G__22332__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__22148 = c;
var G__22148__$1 = (((G__22148 == null))?null:G__22148.constructor);
if((G__22148__$1 == null)){
return null;
} else {
return G__22148__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__22164 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22165 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22165);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22164);
}});
...
var c = this;
var G__22183_22357 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22183_22357 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22183_22357);
}
...
var renders_22367 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22368 = cljs.core.first(cljs.core.vals(renders_22367));
...
if((cljs.core.count(renders_22367) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22367))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22368)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22368], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22201 = o;
reagent.impl.component.goog$module$goog$object.set(G__22201,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22234 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22235 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22235);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22234);
}});
...
var vec__22249 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22249,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22249,(1),null);
...
var G__22271 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22271 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22271);
}
});
}),[]);
