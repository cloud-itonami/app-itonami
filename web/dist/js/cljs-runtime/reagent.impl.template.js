...
var G__22418 = o;
reagent.impl.template.goog$module$goog$object.set(G__22418,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22419 = o;
reagent.impl.template.goog$module$goog$object.set(G__22419,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22469__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22469 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22470__i = 0, G__22470__a = new Array(arguments.length -  0);
while (G__22470__i < G__22470__a.length) {G__22470__a[G__22470__i] = arguments[G__22470__i + 0]; ++G__22470__i;}
  args = new cljs.core.IndexedSeq(G__22470__a,0,null);
} 
return G__22469__delegate.call(this,args);};
G__22469.cljs$lang$maxFixedArity = 0;
G__22469.cljs$lang$applyTo = (function (arglist__22471){
var args = cljs.core.seq(arglist__22471);
return G__22469__delegate(args);
});
...
var G__22421 = props;
var G__22421__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22421,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22421);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22421__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22422 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22422,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22422;
}
})(),id_class);
...
var G__22425 = (cljs.core.count(argv) - first_child);
switch (G__22425) {
case (0):
...
var vec__22426 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22426,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22426,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22426,(2),null);
...
var temp__5829__auto___22485 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22485 == null)){
} else {
var key_22486 = temp__5829__auto___22485;
(jsprops.key = key_22486);
}
...
var temp__5829__auto___22491 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22491 == null)){
} else {
var key_22493 = temp__5829__auto___22491;
(jsprops.key = key_22493);
}
...
var temp__5829__auto___22496 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22496 == null)){
} else {
var key_22499 = temp__5829__auto___22496;
(jsprops.key = key_22499);
}
...
var temp__5829__auto___22511 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22511 == null)){
} else {
var key_22513 = temp__5829__auto___22511;
(jsprops.key = key_22513);
}
...
var temp__5829__auto___22519 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22519 == null)){
} else {
var key_22520 = temp__5829__auto___22519;
(jsprops.key = key_22520);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22432_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22432_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22436 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22436,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22436,(1),null);
...
break;
default:
var G__22528 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22529 = compiler;
v = G__22528;
compiler = G__22529;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22460 = (function (opts,id,fn_to_element,parse_fn,meta22461){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22460.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22462,meta22461__$1){
var self__ = this;
var _22462__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22460(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22461__$1));
}));

(reagent.impl.template.t_reagent$impl$template22460.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22462){
var self__ = this;
var _22462__$1 = this;
return self__.meta22461;
}));

(reagent.impl.template.t_reagent$impl$template22460.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22460.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22460.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22460.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22460.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22460.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22461","meta22461",-149644924,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22460.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22460.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22460");

(reagent.impl.template.t_reagent$impl$template22460.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22460");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22460.
 */
reagent.impl.template.__GT_t_reagent$impl$template22460 = (function reagent$impl$template$__GT_t_reagent$impl$template22460(opts,id,fn_to_element,parse_fn,meta22461){
return (new reagent.impl.template.t_reagent$impl$template22460(opts,id,fn_to_element,parse_fn,meta22461));
});
...
return (new reagent.impl.template.t_reagent$impl$template22460(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
